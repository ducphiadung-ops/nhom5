        ...
        <li class="nav-item">
            ...
            <div class="collapse show" id="sub-thuoc-tinh">
                <ul class="sub-menu">
                    ...
                    <li><a href="${pageContext.request.contextPath}/thuoc-tinh/o-cung/hien-thi" class="nav-link-custom active-sub"><i class="fa-solid fa-hard-drive me-1"></i> Ổ cứng</a></li>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        <a href="${pageContext.request.contextPath}/thuoc-tinh/o-cung/sua?id=${oc.id}" class="btn btn-sm btn-outline-secondary px-2.5" style="border-radius: 6px;">
                                            <i class="fa-regular fa-pen-to-square"></i>
                                        </a>
                                        <a href="${pageContext.request.contextPath}/thuoc-tinh/o-cung/xoa?id=${oc.id}"
                                           class="btn btn-sm btn-outline-danger px-2.5 ${!oc.trangThai ? 'disabled pointer-events-none opacity-50' : ''}"
                                           style="border-radius: 6px;" onclick="return confirm('Bạn chắc chắn muốn ngừng kích hoạt Ổ Cứng này?');">
