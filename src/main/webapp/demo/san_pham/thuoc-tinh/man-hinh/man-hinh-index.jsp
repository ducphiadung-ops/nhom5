        ...
        <li class="nav-item">
            ...
            <div class="collapse show" id="sub-thuoc-tinh">
                <ul class="sub-menu">
                    ...
                    <li><a href="${pageContext.request.contextPath}/thuoc-tinh/man-hinh/hien-thi" class="nav-link-custom active-sub"><i class="fa-solid fa-display me-1"></i> Màn hình</a></li>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        <a href="${pageContext.request.contextPath}/thuoc-tinh/man-hinh/sua?id=${mh.id}" class="btn btn-sm btn-outline-secondary px-2.5" style="border-radius: 6px;">
                                            <i class="fa-regular fa-pen-to-square"></i>
                                        </a>
                                        <a href="${pageContext.request.contextPath}/thuoc-tinh/man-hinh/xoa?id=${mh.id}"
                                           class="btn btn-sm btn-outline-danger px-2.5 ${!mh.trangThai ? 'disabled pointer-events-none opacity-50' : ''}"
                                           style="border-radius: 6px;" onclick="return confirm('Bạn chắc chắn muốn ngừng kích hoạt Màn Hình này?');">
