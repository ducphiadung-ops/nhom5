...
<!-- 🎨 --- SIDEBAR ĐÃ CẬP NHẬT ĐƯỜNG DẪN KẾT NỐI VỚI KHÁCH HÀNG, NHÂN VIÊN, HÓA ĐƠN --- -->
<aside class="sidebar">
    <div class="brand">
    ...
    <ul class="nav-menu">
        <li class="nav-item">
            <a href="${pageContext.request.contextPath}/tong_quan" class="nav-link-custom"><i class="fa-solid fa-border-all"></i> Trang tổng quan</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a href="#sub-san-pham" class="nav-link-custom active d-flex justify-content-between align-items-center" data-bs-toggle="collapse" role="button" aria-expanded="true">
        ...
        <!-- 👤 QUẢN LÝ KHÁCH HÀNG (KhachHangServlet) -->
        <li class="nav-item">
        ...
        <!-- 👔 QUẢN LÝ NHÂN VIÊN (NhanVienServlet) -->
        <li class="nav-item">
